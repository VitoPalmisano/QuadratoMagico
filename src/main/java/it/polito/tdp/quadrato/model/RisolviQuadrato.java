	...
	private void cerca(List<Integer> parziale, int livello) {
		...
		if(livello == N2) {
			...
			if(controlla(parziale)) {
				...
				/*
				 *  Non posso aggiungere parziale alle soluzioni,
				 *  semplicemente perche' parziale e'un riferimento
				 *  ad un oggetto che poi verra' muatato all'interno
				 *  del metodo cerca, fino a che, ritornando a ritroso
				 *  fino al livello 0, parziale non verra' impostato
				 *  ad ArrayList vuota
				 */
